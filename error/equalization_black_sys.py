...
#======================output=========================
black_photo_locate = 'gray\\Gray_picture\\images2_black.jpg'
box_locate_before = 'gray\\_before_box\\images2_box.jpg'
photo_locate = 'gray\\_equalization_photo\\new_images2.jpg'
box_locate_after  = 'gray\\_after_box\\images2_box.jpg'
#=====================================================
...
ddb.draw_box(range(255),counter_normal,'gray','灰階(0~255)','像素數','像素分布圖',box_locate_before)
...
ddb.draw_box(range(255),counter_newimg,'gray','灰階(0~255)','像素數','像素分布圖',box_locate_after)