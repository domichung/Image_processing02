...
#=======================input=========================
img = cv2.imread('Original_picture\\images1.jpg')
#=====================================================

#======================output=========================
box_locate_before_R = 'color\\_before_box\\RED\\images1_box.jpg'
box_locate_before_G = 'color\\_before_box\\GREEN\\images1_box.jpg'
box_locate_before_B = 'color\\_before_box\\BLUE\\images1_box.jpg'
photo_locate = 'color\\_equalization_photo\\new_images1.jpg'
box_locate_after_R  = 'color\\_after_box\\RED\\images1_box.jpg'
box_locate_after_G  = 'color\\_after_box\\GREEN\\images1_box.jpg'
box_locate_after_B  = 'color\\_after_box\\BLUE\\images1_box.jpg'
#=====================================================
...
ddb.draw_box(range(255),counter_normal_r,'gray','灰階(0~255)','像素數','紅色像素分布圖',box_locate_before_R)
ddb.draw_box(range(255),counter_normal_g,'gray','灰階(0~255)','像素數','綠色像素分布圖',box_locate_before_G)
ddb.draw_box(range(255),counter_normal_b,'gray','灰階(0~255)','像素數','藍色像素分布圖',box_locate_before_B)
...
ddb.draw_box(range(255),counter_new_normal_r,'gray','灰階(0~255)','像素數','紅色像素分布圖',box_locate_after_R)
ddb.draw_box(range(255),counter_new_normal_g,'gray','灰階(0~255)','像素數','綠色像素分布圖',box_locate_after_G)
ddb.draw_box(range(255),counter_new_normal_b,'gray','灰階(0~255)','像素數','藍色像素分布圖',box_locate_after_B)